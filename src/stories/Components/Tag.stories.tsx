...
\`\`\`
  ...
  argTypes: {
    'data-color': {
      control: 'select',
      options: ['accent', 'brand1', 'brand2', 'brand3', 'neutral', 'success', 'warning', 'danger', 'info'],
...
export const WithIcons: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
      <Tag data-color="neutral" data-size="md" style={{ paddingInlineStart: 'var(--ds-spacing-1)' }}>
        <SparklesIcon fontSize="1rem" aria-hidden style={{ marginInlineEnd: 'var(--ds-spacing-1)' }} />
        AI-generated
      </Tag>
      <Tag data-color="success" data-size="md" style={{ paddingInlineStart: 'var(--ds-spacing-1)' }}>
        <CheckmarkCircleIcon fontSize="1rem" aria-hidden style={{ marginInlineEnd: 'var(--ds-spacing-1)' }} />
        Verified
      </Tag>
      <Tag data-color="warning" data-size="md" style={{ paddingInlineStart: 'var(--ds-spacing-1)' }}>
        <ExclamationmarkTriangleIcon fontSize="1rem" aria-hidden style={{ marginInlineEnd: 'var(--ds-spacing-1)' }} />
        Review needed
      </Tag>
      <Tag data-color="info" data-size="md" style={{ paddingInlineStart: 'var(--ds-spacing-1)' }}>
        <InformationSquareIcon fontSize="1rem" aria-hidden style={{ marginInlineEnd: 'var(--ds-spacing-1)' }} />
        New
      </Tag>
    </div>
  ),
...
export const Variants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--ds-spacing-4)' }}>
      <div>
        <h4 style={{ marginBottom: 'var(--ds-spacing-2)', fontSize: 'var(--ds-font-size-sm)' }}>Default (filled)</h4>
        <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
          {['accent', 'brand1', 'brand2', 'brand3', 'neutral', 'success', 'warning', 'danger', 'info'].map((color) => (
      ...
      <div>
        <h4 style={{ marginBottom: 'var(--ds-spacing-2)', fontSize: 'var(--ds-font-size-sm)' }}>Outline</h4>
        <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
          {['accent', 'brand1', 'brand2', 'brand3', 'neutral', 'success', 'warning', 'danger', 'info'].map((color) => (
...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--ds-spacing-6)' }}>
      <div>
        <Heading level={3} data-size="sm" style={{ marginBottom: 'var(--ds-spacing-3)' }}>Colors</Heading>
        <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
          <Tag data-color="neutral">Neutral</Tag>
          <Tag data-color="success">Success</Tag>
          <Tag data-color="warning">Warning</Tag>
      ...
      <div>
        <Heading level={3} data-size="sm" style={{ marginBottom: 'var(--ds-spacing-3)' }}>Variants</Heading>
      ...
      <div>
        <Heading level={3} data-size="sm" style={{ marginBottom: 'var(--ds-spacing-3)' }}>Status Examples</Heading>
        <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
          <Tag data-color="success">Active</Tag>
          <Tag data-color="warning">Pending</Tag>
          <Tag data-color="danger">Cancelled</Tag>
