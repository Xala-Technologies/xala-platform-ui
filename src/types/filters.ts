 ...
 * Use generic terms: "resource", "item", "amenity" instead of domain-specific terms.
 */

/**
 * Resource type for filtering
 */
export type ResourceType = 'SPACE' | 'EQUIPMENT' | 'VEHICLE' | 'OUTDOOR' | 'SERVICE';

/**
 * Resource status for filtering
 */
...
export interface FilterState {
  ...
  resourceType?: ResourceType | 'ALL' | 'all';
