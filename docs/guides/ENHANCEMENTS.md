...
#### Icons (`packages/platform-ui/src/utils/icons.tsx`)
...
#### Badges (`packages/platform-ui/src/utils/badges.tsx`)
...
#### Status (`packages/platform-ui/src/utils/status.tsx`)
...
```typescript
// Icons
import { HeartIcon, MapPinIcon } from '@xala-technologies/platform-ui/utils';

// Badges
import { Badge, BadgeList, getBadgeColor } from '@xala-technologies/platform-ui/utils';

// Status
import { StatusDot, getStatusColor, getPeriodStatusColors } from '@xala-technologies/platform-ui/utils';
```
