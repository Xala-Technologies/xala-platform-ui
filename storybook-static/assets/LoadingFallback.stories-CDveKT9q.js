...
\`\`\`
        `}}},argTypes:{message:{control:"text",description:"Loading message"}},tags:["autodocs"]},y=()=>{const e=v();return o.jsx(s,{message:e("platform.common.loading")})},t={render:function(){return o.jsx(y,{})}},S=()=>{const e=v();return o.jsx(s,{message:e("storybook.demo.loadingContent")})},l={render:function(){return o.jsx(S,{})}},i={args:{message:"Loading..."}};var d,u,g;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: function Render() {
    return <DefaultLoadingFallback />;
  }
}`,...(g=(u=t.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var f,A,b;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: function Render() {
    return <CustomMessageLoadingFallback />;
  }
}`,...(b=(A=l.parameters)==null?void 0:A.docs)==null?void 0:b.source}}};var C,L,h;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    message: 'Loading...'
  }
}`,...(h=(L=i.parameters)==null?void 0:L.docs)==null?void 0:h.source}}};const Z=["Default","CustomMessage","EnglishMessage"];export{l as CustomMessage,t as Default,i as EnglishMessage,Z as __namedExportsOrder,W as default};
//# sourceMappingURL=LoadingFallback.stories-CDveKT9q.js.map
