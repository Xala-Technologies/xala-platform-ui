...
import { Button, Textfield, Fieldset, Paragraph, Label, cn } from '@xala-technologies/platform-ui-core';

// Inline CalendarIcon to avoid dependency on core primitives/icons
const CalendarIcon = () => (
  <svg
    width="16"
    height="16"
