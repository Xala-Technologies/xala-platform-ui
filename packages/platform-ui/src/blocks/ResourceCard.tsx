 ...
 * ResourceCard
 *
 * A reusable card component for displaying resource/resource information.
...
export type ResourceCardVariant = 'grid' | 'detailed';
...
const StarIcon = () => (
  <svg
    ...
    height="14"
    viewBox="0 0 24 24"
    fill="var(--ds-color-warning-base-default)"
    stroke="var(--ds-color-warning-base-default)"
    strokeWidth="2"
  >
...
const PeopleIcon = () => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="none"
    stroke="var(--ds-color-neutral-text-subtle)"
    strokeWidth="2"
  >
...
export function ResourceCard({
  ...
  if (variant === 'detailed') {
    return (
      <div
        className={cn('resource-object-card resource-object-card--detailed', className)}
        style={{
          position: 'relative',
        ...
        {(showCapacity || showPrice) && (
          <div
            style={{
              ...
              alignItems: 'center',
              margin:
                'auto calc(var(--ds-spacing-6) * -1) calc(var(--ds-spacing-6) * -1) calc(var(--ds-spacing-6) * -1)',
