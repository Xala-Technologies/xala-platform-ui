...
export function ReturnPolicyCard({
    ...
    return (
        <Card className={cn('return-policy-card', className)} style={{ padding: compact ? 'var(--ds-spacing-3)' : 'var(--ds-spacing-4)' }}>
            <div style={containerStyle}>
                ...
                {policy.refundPercent !== undefined && (
                    <div style={fieldStyle}>
                        <CheckIcon size={14} />
                        <Paragraph data-size="sm" style={{ margin: 0 }}>
                            {labels.refund}: {policy.refundPercent}{labels.refundText}
                        </Paragraph>
                    </div>
                )}
                ...
                {policy.lateRefundPercent !== undefined && (
                    <div style={fieldStyle}>
                        <Paragraph data-size="sm" style={{ margin: 0, color: 'var(--ds-color-neutral-text-subtle)' }}>
                            {labels.lateRefund}: {policy.lateRefundPercent > 0 ? `${policy.lateRefundPercent}${labels.refundText}` : labels.noRefund}
                        </Paragraph>
                    </div>
                )}
                        ...
                        <ul style={listStyle}>
                            {policy.conditions.map((condition, index) => (
                                <li key={index} style={listItemStyle}>
                                    <span style={{ color: 'var(--ds-color-accent-base-default)', marginTop: 2 }}>•</span>
                                    <Paragraph data-size="sm" style={{ margin: 0 }}>
                                        {condition}
                                    </Paragraph>
                                </li>
