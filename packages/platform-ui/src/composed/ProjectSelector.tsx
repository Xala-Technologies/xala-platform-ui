...
export function ProjectSelector({
    ...
    return (
        <Popover content={dropdownContent} open={isOpen} onOpenChange={setIsOpen} position="bottom-start">
            <Button variant="tertiary" data-size={size} onClick={() => setIsOpen(!isOpen)} style={styles.trigger}>
                <div style={styles.triggerAvatar}>{selectedProject?.name.charAt(0).toUpperCase() ?? '?'}</div>
