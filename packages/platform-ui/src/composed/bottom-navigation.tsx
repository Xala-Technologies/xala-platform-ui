 ...
 * Following platform design patterns - thumb-friendly navigation
            ...
            return (
              <ItemWrapper
                ...
                style={{
                  ...
                  minHeight: 'var(--ds-spacing-12)', // Minimum 44px + 4px padding for WCAG AA touch target
                  maxWidth: 'var(--ds-sizing-42)',
