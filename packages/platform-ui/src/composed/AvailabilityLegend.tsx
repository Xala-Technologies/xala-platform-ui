...
export const defaultBookingLegendItems: LegendItem[] = [
    { status: 'available', label: 'Ledig', color: 'var(--ds-color-success-base-default)', pattern: 'solid' },
    { status: 'reserved', label: 'Reservert', color: 'var(--ds-color-warning-base-default)', pattern: 'striped' },
    { status: 'booked', label: 'Booket', color: 'var(--ds-color-danger-base-default)', pattern: 'solid' },
    { status: 'closed', label: 'Stengt', color: 'var(--ds-color-neutral-base-default)', pattern: 'dotted' },
    { status: 'unavailable', label: 'Utilgjengelig', color: 'var(--ds-color-neutral-surface-hover)', pattern: 'striped' },
];
...
export const defaultBookingLegendItemsEn: LegendItem[] = [
    { status: 'available', label: 'Available', color: 'var(--ds-color-success-base-default)', pattern: 'solid' },
    { status: 'reserved', label: 'Reserved', color: 'var(--ds-color-warning-base-default)', pattern: 'striped' },
    { status: 'booked', label: 'Booked', color: 'var(--ds-color-danger-base-default)', pattern: 'solid' },
    { status: 'closed', label: 'Closed', color: 'var(--ds-color-neutral-base-default)', pattern: 'dotted' },
    { status: 'unavailable', label: 'Unavailable', color: 'var(--ds-color-neutral-surface-hover)', pattern: 'striped' },
];
