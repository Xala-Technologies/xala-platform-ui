 ...
 *
 * @module @xala-technologies/platform/ui/composed/MobileNav
 */
...
export const MobileNavToggle = forwardRef<HTMLButtonElement, MobileNavToggleProps>(
  (
    ...
    const buttonStyle: React.CSSProperties = {
      ...
      minWidth: 'var(--ds-spacing-11)',
      minHeight: 'var(--ds-spacing-11)',
      padding: 'var(--ds-spacing-2)',
      border: 'none',
      borderRadius: 'var(--ds-border-radius-md, 5px)',
      backgroundColor: isHovered ? 'var(--ds-color-neutral-surface-hover)' : 'transparent',
 ...
 *     { id: '2', label: 'Mine resourceRequester', href: '/resourceRequests', icon: <CalendarIcon />, badge: 3 },
 ...
 *         { id: '2', label: 'Mine resourceRequester', href: '/resourceRequests' },
 *       ]
 *     },
 *     {
 *       title: 'Innstillinger',
