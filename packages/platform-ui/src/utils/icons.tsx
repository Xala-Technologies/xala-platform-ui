 ...
 *
 * Centralized icon library using inline SVG for portability.
 * All icons follow Designsystemet design principles.
 */
 ...
 */
export function HeartIcon({ filled, size = 20, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
