...
export const brandColors = {
  navy: {
    hex: 'var(--ds-color-accent-base-hover)',
    oklch: 'oklch(0.28 0.09 264)',
    usage: 'Core trust color',
  },
  blue: {
    hex: 'var(--ds-color-accent-base-default)',
    oklch: 'oklch(0.45 0.12 262)',
    usage: 'Primary interaction',
  },
  aqua: {
    hex: 'var(--ds-color-accent-surface-default)',
    oklch: 'oklch(0.82 0.08 205)',
    usage: 'Availability/calm',
  },
  ice: {
    hex: 'var(--ds-color-accent-surface-subtle)',
    oklch: 'oklch(0.94 0.03 205)',
    usage: 'Surfaces/backgrounds',
  },
  green: {
    hex: 'var(--ds-color-success-base-default)',
    oklch: 'oklch(0.72 0.14 130)',
    usage: 'Location/success',
  },
  white: {
    hex: 'var(--ds-color-neutral-background-default)',
    oklch: 'oklch(1.0 0 0)',
    usage: 'Contrast',
  },
  charcoal: {
    hex: 'var(--ds-color-neutral-text-default)',
...
:root {
  --brand-navy: var(--ds-color-accent-base-hover);
  --brand-blue: var(--ds-color-accent-base-default);
  --brand-aqua: var(--ds-color-accent-surface-default);
  --brand-ice: var(--ds-color-accent-surface-subtle);
  --brand-green: var(--ds-color-success-base-default);
  --brand-white: var(--ds-color-neutral-background-default);
  --brand-charcoal: var(--ds-color-neutral-text-default);
}
` as const;
