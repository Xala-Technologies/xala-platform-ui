...
import { SimpleSidebar, SidebarHeaderArea, SidebarPanel, SidebarScrollArea, Stack, Paragraph, Card, Button } from '../../index';
      ...
      <Stack spacing="var(--ds-spacing-4)" style={{ maxWidth: '800px', padding: 'var(--ds-spacing-4)' }}>
        <Card data-color="neutral" data-size="medium">
          <Stack spacing="var(--ds-spacing-4)">
            ...
            <div style={{ display: 'flex', height: '400px', border: '1px solid var(--ds-color-neutral-border-default)', borderRadius: 'var(--ds-border-radius-md)' }}>
              <SimpleSidebar>
                <SidebarHeaderArea>
                  <Paragraph data-size="sm" style={{ margin: 0 }}>{t('storybook.sidebar.header')}</Paragraph>
                </SidebarHeaderArea>
                <SidebarScrollArea>
                  <Stack spacing="var(--ds-spacing-2)" style={{ padding: 'var(--ds-spacing-2)' }}>
                    <Button data-color="neutral" style={{ width: '100%', justifyContent: 'flex-start' }}>{t('storybook.sidebar.item1')}</Button>
                    <Button data-color="neutral" style={{ width: '100%', justifyContent: 'flex-start' }}>{t('storybook.sidebar.item2')}</Button>
                    <Button data-color="neutral" style={{ width: '100%', justifyContent: 'flex-start' }}>{t('storybook.sidebar.item3')}</Button>
                  </Stack>
                </SidebarScrollArea>
              </SimpleSidebar>
