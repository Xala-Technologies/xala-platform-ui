...
export function IntroductionDocsDescription() {
  ...
  return (
    <div>
      ...
      <ul>
        <li><strong>{t('storybook.overview.accessibilityFirst')}</strong>: {t('storybook.overview.accessibilityFirstDesc')}</li>
        <li><strong>{t('storybook.overview.designTokens')}</strong>: {t('storybook.overview.designTokensDesc')}</li>
        <li><strong>{t('storybook.overview.components')}</strong>: {t('storybook.overview.componentsDesc')}</li>
        <li><strong>{t('storybook.overview.multiTenancy')}</strong>: {t('storybook.overview.multiTenancyDesc')}</li>
        <li><strong>{t('storybook.overview.internationalization')}</strong>: {t('storybook.overview.i18nDesc')}</li>
        <li><strong>{t('storybook.overview.themeSupport')}</strong>: {t('storybook.overview.themeSupportDesc')}</li>
      </ul>
      
      <h2>{t('storybook.demo.builtWith', 'Built With')}</h2>
      <ul>
        <li><a href="https://designsystemet.no/">Designsystemet</a> - {t('storybook.demo.norwegianDesignSystem', 'Norwegian Design System')}</li>
...
export function GettingStartedDocsDescription() {
  ...
  return (
    <div>
      ...
      <p>{t('storybook.gettingStarted.quickGuide', 'Quick guide to start building with the Xala Platform Design System.')}</p>
      
      <h2>{t('storybook.gettingStarted.installation')}</h2>
      <pre><code>pnpm add @xala-technologies/platform</code></pre>
      ...
      <ul>
        ...
        <li>{t('storybook.gettingStarted.followA11yGuidelines', 'Follow accessibility guidelines')}</li>
