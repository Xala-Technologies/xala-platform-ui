...
export const CustomColors: Story = {
    args: {
        items: [
            { status: 'premium', label: 'Premium', color: 'var(--ds-color-accent-base-default)', pattern: 'solid' },
            { status: 'standard', label: 'Standard', color: 'var(--ds-color-info-base-default)', pattern: 'solid' },
            { status: 'economy', label: 'Økonomi', color: 'var(--ds-color-neutral-base-default)', pattern: 'striped' },
        ],
        layout: 'horizontal',
        size: 'md',
    },
