...
const fullDetails: DetailsInfo = {
  specifications: ['Kapasitet: 100 personer', 'Areal: 200 kvm', 'Takhøyde: 3,5 meter'],
  includedItems: ['Lydanlegg', 'Mikrofon', '50 stoler', '10 bord'],
...
export const EquipmentRental: Story = {
  args: {
    ...
    details: {
      specifications: ['PA-anlegg 500W', '2x høyttalere', '1x mikser', 'Alle kabler inkludert'],
      includedItems: ['Koffert med alt utstyr', 'Brukerveiledning', 'Nødkontakt'],
