...
export const CustomPolicy: Story = {
  args: {
    policy: {
      type: 'custom',
      customDescription:
        'Kontakt oss for avbestillingsvilkår. Spesielle betingelser gjelder for helger og helligdager.',
      conditions: ['Sesongbaserte avbestillingsregler', 'Depositum kr 1000 refunderes ikke'],
    },
  },
  decorators: [
    (Story) => (
...
export const EnglishLabels: Story = {
  args: {
    policy: {
      ...
      refundPercent: 100,
      lateRefundPercent: 0,
      conditions: ['Free cancellation up to 48 hours before', 'No refund for late cancellation'],
    },
    labels: {
