...
export function QuantitySlotCalendar({
    ...
    const dayColumnStyle = (isToday: boolean): React.CSSProperties => ({
        ...
        backgroundColor: isToday ? 'var(--ds-color-accent-surface-default)' : 'var(--ds-color-neutral-surface-subtle)',
    ...
    const slotButtonStyle = (available: number, total: number, isSelected: boolean): React.CSSProperties => {
        ...
        return {
            ...
            padding: 'var(--ds-spacing-2)',
            border: isSelected ? '2px solid var(--ds-color-accent-border-default)' : '1px solid var(--ds-color-neutral-border-subtle)',
                                    ...
                                    daySlots.map((slot) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={slotButtonStyle(slot.availableQuantity, slot.totalQuantity, isSelected)}
                                            >
                                                <span style={{ fontSize: 'var(--ds-font-size-sm)', fontWeight: 'var(--ds-font-weight-medium)' }}>
                                                    {slot.time}
                                                </span>
                                                <span style={quantityBadgeStyle(slot.availableQuantity, slot.totalQuantity)}>
                                                    {isSoldOut
                                                        ? labels.soldOut
