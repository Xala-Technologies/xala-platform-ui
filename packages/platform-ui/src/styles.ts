 ...
 * All other imports should go through the @xala-technologies/platform/ui facade to ensure
 * consistent styling and prevent duplicate CSS loading.
 *
 * @example
 * ```typescript
 * import '@xala-technologies/platform/ui/styles'; // Do this once in your application's entry point
 * ```
 */
 ...
 * Theme CSS URLs are provided by @xala-technologies/platform/ui/themes, which enables dynamic theme
