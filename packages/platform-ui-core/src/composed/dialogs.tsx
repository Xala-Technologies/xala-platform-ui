  ...
  return (
    <dialog
      ...
      style={{
        ...
        maxWidth: '420px',
        width: '90vw',
        boxShadow: '0 20px 40px var(--ds-color-neutral-border-default)',
 ...
 *   title="Slett resourceRequest?"
 *   description="Er du sikker på at du vil slette denne resourceRequesten?"
 *   confirmText="Slett"
 *   cancelText="Avbryt"
 *   variant="danger"
 * />
 ...
 *   title="ResourceRequest bekreftet!"
...
export function DialogProvider({ children }: { children: ReactNode }) {
  ...
  const alert = useCallback(
    (options: Omit<AlertDialogProps, 'open' | 'onClose'>): Promise<void> => {
      return new Promise((resolve) => {
        setDialog({
          type: 'alert',
          props: {
