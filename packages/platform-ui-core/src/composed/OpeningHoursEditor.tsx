...
export function OpeningHoursEditor({
  ...
  return (
    <Fieldset className={cn('opening-hours-editor', className)}>
      ...
      {labels.helperText && <Fieldset.Description>{labels.helperText}</Fieldset.Description>}
      ...
      <div style={containerStyle}>
        ...
        {dayOrder.map((day) => {
          ...
          return (
            <div key={day} style={rowStyle} role="group" aria-label={dayLabel}>
              {/* Day checkbox */}
              <Checkbox
                id={day}
              ...
              <Label
                id={dayLabelId}
                htmlFor={day}
                style={{ marginLeft: 'calc(var(--ds-spacing-2) * -1)', cursor: 'pointer' }}
              >
                {dayLabel}
              </Label>
